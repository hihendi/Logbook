                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          ...
                          <a href="<?php echo e(route('marketing.create')); ?>" class="btn btn-primary btn-medium pull-right">Create User</a>
                          <div id="id_datatable">
  ...
  <script>
    ...
    $(function(){
        $('#marketing-table').DataTable({
          processing: true,
          serverSide: true,
          ajax: '<?php echo e(route('marketing.datatable')); ?>',
          columns:
          [
              {data: 'nama_pelanggan'},
              {data: 'alamat'},
    ...
    $('#marketing-table').on('click', '.btn-del', function(e){
      ...
      if (confirm('Apa kamu yakin?') == true)
      {
          $.ajax({
            type     : 'delete',
            url      : "<?php echo e(route('marketing.delete')); ?>",
            data     : {id:id_del},
            dataType : 'json',
