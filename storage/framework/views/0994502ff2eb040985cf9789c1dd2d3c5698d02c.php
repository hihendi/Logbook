                              ...
                              <div class="form-group<?php echo e($errors->has('impact') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="username" type="text" class="form-control" name="username"
                                           value="<?php echo e($marketing->username); ?>" placeholder="Masukkan Username "
                                           required autofocus>
                              ...
                              <div class="form-group<?php echo e($errors->has('segment ') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                  <select class="form-control" name="paket_langganan" id="paket_langganan">
                                        <option value="<?php echo e(old($marketing->paket_langganan)); ?>" selected='selected'>Pilih Paket Berlangganan</option>
                            ...
                            <div class="form-group<?php echo e($errors->has('segment ') ? ' has-error' : ''); ?>">
                              ...
                              <div class="col-md-6">
                                <select class="form-control" name="id_customer" id="id_customer">
                                  ...
                                  <?php if($errors->has('id_customer')): ?>
                                      <span class="help-block">
                                      <strong><?php echo e($errors->first('id_customer')); ?></strong>
                                  </span>
                                  <?php endif; ?>
                              </div>
                          </div>
